...
![显卡信息](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\显卡信息.png)

安装Python（版本>=3.8）以及能够调用CUDA加速的PyTorch

![查看自己电脑CUDA](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\查看自己电脑CUDA.png)

![PyTorch下载](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\PyTorch下载.png)
...
![image-20250109225426972](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\COCO数据集.png)
...
![1](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\data2csv执行成功.png)	
...
![image-20250110191727758](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\csv2json执行完成.png)
...
![image-20250110193203354](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\swanlab使用.png)
...
![2](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\训练结果图表.png)



![3](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\训练结果图.png)
...
![4](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\预测图片.png)	

更改这里需要预测的图片的路径

这里我们用两个图片测试了下

![apple](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\apple.jpeg)	<img src="C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\dandan.jpg" alt="QQ图片20240722231535" style="zoom:25%;" />

![5](C:\Users\王舒贤\Desktop\文件\学习\AI\Qwen2-VL多模态大模型微调实战.assets\训练结果测试.png)
